...
public class HttpClientUtil {
		...
		try {
			...
			if (postMethod.getStatusCode() == HttpStatus.SC_OK) {
				...
				PrintWriter out = new PrintWriter(new BufferedWriter(
						new FileWriter(new File("test1.txt"))));
	...
	public static void main(String[] args) {
		String str = HttpClientUtil.get("http://www.iteye.com/").toString();
		// String
		// str=HttpClientUtil.post("http://blog.csdn.net/xxx823952375/article/",new
		// HashMap<String, String>()).toString();
	...
	public void test1() throws Exception {
		System.out
				.println(httpGet("http://blog.csdn.net/xxx823952375/article/"));
	}
