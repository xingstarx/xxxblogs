...
public class JsoupParserUtil {
	 ...
	 * @return
	 */
	public static Elements getElementsByTagName(Document document,
			String tagName) {
	 ...
	 * @return
	 */
	public static Elements getElementsByClassName(Document document,
			String className) {
		Elements elements = null;
	 ...
	 * @return
	 */
	public static Elements getElementsByClassName(Element element,
			String className) {
		Elements resultElements = null;
	 ...
	 * @return
	 */
	public static Elements getElementsByAttributeNameKey(Document document,
	 ...
	 * @return
	 */
	public static Elements getElementsByAttributeNameKey(Element element,
			String attributeNameKey) {
		Elements resultElements = null;
	 ...
	 * @return
	 */
	public static Elements getElementsByAttributeNameValue(Document document,
	 ...
	 * @return
	 */
	public static Elements getElementsByAttributeNameValue(Element element,
			String attributeKey, String attributeValue) {
		Elements resultElements = null;
	 ...
	 * @return
	 */
	public static Elements getElementsByAttributeNameStartWithValue(
	 ...
	 * @return
	 */
	public static Elements getElementsByAttributeValueContaining(
	 ...
	 * @return
	 */
	public static Elements getElementsByAttributeValueEnding(Document document,
	 ...
	 * @return
	 */
	public static Elements getElementsByAttributeValueEnding(Element element,
			String attributeKey, String valueSuffix) {
		Elements elements = null;
	 ...
	 * @return
	 */
	public static Elements getElementsByAttributeValueMatching(
	 ...
	 * @return
	 */
	public static Elements getElementsByAttributeValueMatching(Element element,
	 ...
	 * @return
	 */
	public static Elements getElementsByAttributeValueNot(Document document,
			String attributeKey, String attributeValue) {
		Elements elements = null;
		if (document != null && attributeKey != null
	 ...
	 * @return
	 */
	public static Elements getElementsByAttributeValueNot(Element element,
			String attributeKey, String attributeValue) {
		Elements elements = null;
		if (element != null && attributeKey != null && !"".equals(attributeKey)
	 ...
	 * @return
	 */
	public static Elements getMoreElementsBySelectStr(Document document,
			String selectStr) {
	 ...
	 * @return
	 */
	public static Elements getMoreElementsBySelectStr(Element element,
			String selectStr) {
	 ...
	 * @return
	 */
	public static Element getSingleElementBySelectStr(Document document,
			String selectStr) {
	 ...
	 * @return
	 */
	public static Element getSingleElementBySelectStr(Element element,
			String selectStr) {
	 ...
	 * @return
	 */
	public static String getSingleElementHtmlBySelectStr(Document document,
			String selectStr) {
	 ...
	 * @return
	 */
	public static String getSingleElementHtmlBySelectStr(Element element,
			String selectStr) {
